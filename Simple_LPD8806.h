...
class Simple_LPD8806 {

 public:

  Simple_LPD8806(uint16_t n, uint8_t dpin, uint8_t cpin); // Configurable pins
  Simple_LPD8806(uint16_t n); // Use SPI hardware; specific pins only
